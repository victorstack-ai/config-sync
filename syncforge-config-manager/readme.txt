...
1. Admin dashboard with export, import, diff preview, and ZIP transfer controls.
2. Diff view comparing active database configuration with YAML files on disk.
3. Export results showing per-provider file and item counts.
4. Per-plugin YAML files in the options directory.
